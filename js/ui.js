...
App.renderOrgSelector = function (container) {
    ...
    employeeLoginBtn.innerHTML = '\u{1F464} Soy Colaborador';
        ...
        <div class="header-main">
            <div class="title-row">
                ...
                <button id="btn-admin" class="${state.isAdmin ? 'active' : ''}">
                    ${state.isAdmin ? '\u{1F513} Salir Admin' : '\u{1F512} Admin'}
                </button>
            </div>
